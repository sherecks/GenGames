...
function App() {
  ...
  return (
    <div>
      <div className="flex flex-wrap justify-center bg-custom-background" >

        <div className="flex flex-wrap justify-between mr-12 ml-12">
          <img className="w-62" src="./logo.png"></img>
        ...
        <div className="flex flex-wrap justify-center mx-0">
          <div>
            <p className="">
            <img className="w-68" src="./welcome.png"></img>
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap justify-center">
          {games.map((game, index) => (
            <div className="relative flex flex-col items-center mb-8 mx-4" key={index}>
              ...
              <div>
                <img className="w-60 h-42 sm:w-64 md:h-80 rounded-xl shadow-xl border-4 border-black saturate-0 brightness-75" src={game.image} alt={game.name} />
